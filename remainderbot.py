...
def joinclass(class_name,start_time,end_time):
	...
	discord_webhook.send_msg(class_name=class_name,status="class starts now",start_time=start_time,end_time=end_time)
	...
	# print("Class left")
	discord_webhook.send_msg(class_name=class_name,status="class ends now",start_time=start_time,end_time=end_time)
